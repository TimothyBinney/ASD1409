...
/**
 Base class for all BinneyTimothy_ASD1409_RemoteData views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the BinneyTimothy_ASD1409_RemoteData view hierarchy (such as wrapped iOS UIViews) was touched.
