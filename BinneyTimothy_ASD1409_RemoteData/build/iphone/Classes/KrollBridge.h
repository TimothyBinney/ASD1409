...
@interface BinneyTimothy_ASD1409_RemoteDataObject : KrollCoverageObject {
#else
@interface BinneyTimothy_ASD1409_RemoteDataObject : KrollObject {
#endif
@private
...
extern NSString * BinneyTimothy_ASD1409_RemoteData$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	BinneyTimothy_ASD1409_RemoteDataObject *_binneytimothy_asd1409_remotedata;
    KrollObject* console;
	BOOL shutdown;
