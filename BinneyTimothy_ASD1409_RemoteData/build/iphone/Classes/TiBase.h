...
// in simulator we redefine to format for BinneyTimothy_ASD1409_RemoteData Developer console
...
{\
	NSString * exceptionName = [@"org.binneytimothy_asd1409_remotedata." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.binneytimothy_asd1409_remotedata";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBinneyTimothy_ASD1409_RemoteDataNativeItemNone = -1, 
	UIBinneyTimothy_ASD1409_RemoteDataNativeItemSpinner = -2,
	UIBinneyTimothy_ASD1409_RemoteDataNativeItemProgressBar = -3,
	
	UIBinneyTimothy_ASD1409_RemoteDataNativeItemSlider = -4,
	UIBinneyTimothy_ASD1409_RemoteDataNativeItemSwitch = -5,
	UIBinneyTimothy_ASD1409_RemoteDataNativeItemMultiButton = -6,
	UIBinneyTimothy_ASD1409_RemoteDataNativeItemSegmented = -7,
	
	UIBinneyTimothy_ASD1409_RemoteDataNativeItemTextView = -8,
	UIBinneyTimothy_ASD1409_RemoteDataNativeItemTextField = -9,
	UIBinneyTimothy_ASD1409_RemoteDataNativeItemSearchBar = -10,
	
	UIBinneyTimothy_ASD1409_RemoteDataNativeItemPicker = -11,
	UIBinneyTimothy_ASD1409_RemoteDataNativeItemDatePicker = -12,
	
	UIBinneyTimothy_ASD1409_RemoteDataNativeItemInfoLight = -13,
	UIBinneyTimothy_ASD1409_RemoteDataNativeItemInfoDark = -14,
	
	UIBinneyTimothy_ASD1409_RemoteDataNativeItemDisclosure = -15,
	
	UIBinneyTimothy_ASD1409_RemoteDataNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all BinneyTimothy_ASD1409_RemoteData instances of
