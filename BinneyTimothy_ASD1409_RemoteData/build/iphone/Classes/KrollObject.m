...
//@interface BinneyTimothy_ASD1409_RemoteDataObject : NSObject
//@end

@interface BinneyTimothy_ASD1409_RemoteDataObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BinneyTimothy_ASD1409_RemoteDataObject class]])
		{
			for (NSString *key in [[(BinneyTimothy_ASD1409_RemoteDataObject*)o modules] allKeys])
			{
