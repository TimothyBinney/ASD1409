...
//Rare exceptions to indicate a bug in the _binneytimothy_asd1409_remotedata code (Eg, function that a subclass should have implemented)
...
/**
 The base class for BinneyTimothy_ASD1409_RemoteData proxies.
 */
