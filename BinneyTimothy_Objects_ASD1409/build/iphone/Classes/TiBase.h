...
// in simulator we redefine to format for BinneyTimothy_Objects_ASD1409 Developer console
...
{\
	NSString * exceptionName = [@"org.binneytimothy_objects_asd1409." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.binneytimothy_objects_asd1409";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIBinneyTimothy_Objects_ASD1409NativeItemNone = -1, 
	UIBinneyTimothy_Objects_ASD1409NativeItemSpinner = -2,
	UIBinneyTimothy_Objects_ASD1409NativeItemProgressBar = -3,
	
	UIBinneyTimothy_Objects_ASD1409NativeItemSlider = -4,
	UIBinneyTimothy_Objects_ASD1409NativeItemSwitch = -5,
	UIBinneyTimothy_Objects_ASD1409NativeItemMultiButton = -6,
	UIBinneyTimothy_Objects_ASD1409NativeItemSegmented = -7,
	
	UIBinneyTimothy_Objects_ASD1409NativeItemTextView = -8,
	UIBinneyTimothy_Objects_ASD1409NativeItemTextField = -9,
	UIBinneyTimothy_Objects_ASD1409NativeItemSearchBar = -10,
	
	UIBinneyTimothy_Objects_ASD1409NativeItemPicker = -11,
	UIBinneyTimothy_Objects_ASD1409NativeItemDatePicker = -12,
	
	UIBinneyTimothy_Objects_ASD1409NativeItemInfoLight = -13,
	UIBinneyTimothy_Objects_ASD1409NativeItemInfoDark = -14,
	
	UIBinneyTimothy_Objects_ASD1409NativeItemDisclosure = -15,
	
	UIBinneyTimothy_Objects_ASD1409NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all BinneyTimothy_Objects_ASD1409 instances of
