...
//Rare exceptions to indicate a bug in the _binneytimothy_objects_asd1409 code (Eg, function that a subclass should have implemented)
...
/**
 The base class for BinneyTimothy_Objects_ASD1409 proxies.
 */
