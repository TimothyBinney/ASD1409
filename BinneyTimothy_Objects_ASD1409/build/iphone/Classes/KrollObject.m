...
//@interface BinneyTimothy_Objects_ASD1409Object : NSObject
//@end

@interface BinneyTimothy_Objects_ASD1409Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[BinneyTimothy_Objects_ASD1409Object class]])
		{
			for (NSString *key in [[(BinneyTimothy_Objects_ASD1409Object*)o modules] allKeys])
			{
