...
/**
 Base class for all BinneyTimothy_Objects_ASD1409 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the BinneyTimothy_Objects_ASD1409 view hierarchy (such as wrapped iOS UIViews) was touched.
