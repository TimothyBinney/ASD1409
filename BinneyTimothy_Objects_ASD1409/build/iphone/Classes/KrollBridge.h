...
@interface BinneyTimothy_Objects_ASD1409Object : KrollCoverageObject {
#else
@interface BinneyTimothy_Objects_ASD1409Object : KrollObject {
#endif
@private
...
extern NSString * BinneyTimothy_Objects_ASD1409$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	BinneyTimothy_Objects_ASD1409Object *_binneytimothy_objects_asd1409;
    KrollObject* console;
	BOOL shutdown;
